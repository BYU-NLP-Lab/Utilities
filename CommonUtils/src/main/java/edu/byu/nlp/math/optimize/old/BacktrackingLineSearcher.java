...
public class BacktrackingLineSearcher implements GradientLineSearcher {
  ...
  public double[] minimize(DifferentiableFunction function, double[] initial, double[] direction) {
    ...
    double initialDirectionalDerivative = DoubleArrays2.innerProduct(function.derivativeAt(initial), direction);
    double[] guess = null;
...
//    }
    while (! sufficientDecreaseObtained) {
      guess = DoubleArrays2.addMultiples(initial, 1.0, direction, stepSize);
...
//      System.out.printf("%f = %f + %f * %f * %f\n",sufficientDecreaseValue,initialFunctionValue,sufficientDecreaseConstant,initialDirectionalDerivative,stepSize);
...
//    return lastGuess;
  ...
  public static void main(String[] args) {
	...
	System.out.println(lineSearcher.minimize(function, new double[] { 0 }, new double[] { 1 })[0]);
  }
}
