...
public class HashCounterTest {
	...
	/**
	 * Test method for {@link edu.byu.nlp.util.HashCounter#getCount(java.lang.Object)}.
	 */
	@Test
	public void testGetCount() {
		...
		assertEquals(2, counter.getCount(diffRef));

		counter.incrementCount(diffRef, 1);
		assertEquals(3, counter.getCount(sameRef1));
		assertEquals(3, counter.getCount(sameRef2));
		assertEquals(3, counter.getCount(diffRef));
